...
class commentVC: UIViewController, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let placeholderWidth = commentTxt.bounds.size.width - placeholderX
        let placeholderHeight = commentTxt.bounds.size.height
        let placeholderFontSize = self.view.frame.size.width / 23
        
        placeholderLbl.frame = CGRectMake(placeholderX, placeholderY, placeholderWidth, placeholderHeight)
        placeholderLbl.text = "Write comment..."
        placeholderLbl.font = UIFont(name: "SF-UI-Text", size: placeholderFontSize)
    ...
    func keyboardWillShow(notification : NSNotification) {
        ...
        UIView.animateWithDuration(0.4) { () -> Void in
            ...
            NSLog("%.2f", self.commentTxt.frame.origin.y)
        }
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.commentLbl.urlLinkTapHandler = { label, handle, range in
    ...
    func tableView(tableView: UITableView, editActionsForRowAtIndexPath indexPath: NSIndexPath) -> [UITableViewRowAction]? {
        ...
        address.backgroundColor = UIColor(patternImage: UIImage(named: "mention.png")!)
