...
class newsVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // pull to refresh
        refresher.addTarget(self, action: #selector(newsVC.loadNotifications), forControlEvents: UIControlEvents.ValueChanged)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        // double tap to like
        let imageTap = UITapGestureRecognizer(target: self, action: #selector(newsVC.onUserImageTap(_:)))
        imageTap.numberOfTapsRequired = 1
        cell.avaImg.userInteractionEnabled = true
        cell.avaImg.addGestureRecognizer(imageTap)
    
        return cell
    }
    
    // double tap like button
    func onUserImageTap(sender: UITapGestureRecognizer)
    {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        redirectToProperView(indexPath)
    }
    
    func redirectToProperView (indexPath : NSIndexPath)
    {
        ...
        if cell.infoLbl.text == "has mentioned you." {
        ...
        else if cell.infoLbl.text == "is now following you." {
            ...
            // going to liked post
        else if cell.infoLbl.text == "likes your post." {
